...
MODERATION_SYSTEM_PROMPT = (
    ...
    "картинки, видео, тексты). Определи, нарушает ли присланный текст правила платформы. "
    "Нарушения: явные призывы к насилию или терроризму; экстремистские материалы; материалы, "
    ...
    "конкретного человека; спам или мошенничество.\n"
    "Обычные творческие промпты — даже мрачные, странные, фантастические, с чёрным юмором — "
    "НЕ являются нарушением, если явно не подпадают под перечисленное выше. Будь снисходителен "
    "к художественному вымыслу.\n"
